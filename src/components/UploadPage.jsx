...
export const UploadPage = (props) => {
    ...
    const uploadSongDetails = (songFile_name,song_cid,coverFile_name,cover_cid) => {
      const song_url = `https://${song_cid}.ipfs.astyanax.io/${songFile_name}`;
      const cover_url = `https://${cover_cid}.ipfs.astyanax.io/${coverFile_name}`;
    ...
    return (
        <div className=" flex flex-col border-[#dee2e6] border-[1px] max-w-lg px-16 py-12 bg-white  w-full">
            <audio src={src} onLoadedMetadata={(e) => setDuration(getTime(e.target.duration))}>
