...
export const SongCard = (props) => {
    ...
    const toggleCheck = (e) => {
        ...
        console.log(checkboxes.get(playlistId));
        const all = new Map();
        ...
        <div className="bg-[#fff] py-4 pr-2 rounded-lg flex flex-row shadow-card max-w-3xl h-min scale-100 hover:scale-[1.008] transition-all duration-150 w-full">
            ...
            <div className="flex flex-col relative w-full">
                ...
                <div className="flex flex-row items-center">
                    ...
                    <span className={"mr-1 " + text_style}>{props.song.ArtistName}</span>
                ...
                <div className="self-end mt-auto">
                    <Popup onOpen={setIntitialCheckbox} trigger={<button className="mr-4 w-40 uppercase  bg-fuchsia-500 text-base font-bold py-1 text-white  rounded-sm scale-100 hover:scale-105 transition-all duration-150" onClick={() => props.buySong(props.song.id)}>Add To PlayList</button>} position="bottom center" contentStyle={contentStyle}>
                    ...
                    <button className={"w-40 uppercase text-base font-bold py-1 text-white  rounded-sm scale-100 transition-all duration-150 " + activeStyle("bg-gray-300","bg-fuchsia-500 hover:scale-105")} disabled={props.disableBuy} onClick={() => props.buySong(props.song.id)}>buy</button>
                </div>
